    ...
    public function execute() {
        ...
        if ($customerSession->isLoggedIn ()) {
            ...
            if ($sellerId != $customerId) {
                 ...
                 */
                $reveiwModel = $objectManager->create ( 'Apptha\Marketplace\Model\Review' );
                ...
                $autoApproval = $objectManager->create ( 'Magento\Framework\App\Config\ScopeConfigInterface' )->getValue ( 'marketplace/review/approval' );
                 ...
                 */
                $storeScope = \Magento\Store\Model\ScopeInterface::SCOPE_STORE;
                $notification = $objectManager->create ( 'Magento\Framework\App\Config\ScopeConfigInterface' )->getValue ( 'marketplace/review/notification' );
                if ($notification == 1) {
                     ...
                     */
                    $seller = $objectManager->get ( 'Apptha\Marketplace\Helper\Data' );
                     ...
                     * Get customer data
                     */
                    $StoreData = $objectManager->create ( 'Apptha\Marketplace\Model\Seller' )->load ( $sellerId );
        ...
        $this->_redirect ( 'marketplace/seller/review/seller_id/' . $sellerId );
    }
}