...
class Save extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        $attributes = '';
        $configProductData = $this->_objectManager->create ( 'Magento\Catalog\Model\Product' )->load ( $parentId );
        ...
        if ($configTypeId == "configurable") {
            ...
            foreach ( $variants as $variantProduct ) {
                $productData = $this->_objectManager->create ( 'Magento\Catalog\Model\Product' )->load ( $variantProduct );
