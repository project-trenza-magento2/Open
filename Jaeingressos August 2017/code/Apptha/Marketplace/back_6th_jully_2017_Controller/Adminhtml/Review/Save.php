...
class Save extends Review {
    ...
    public function execute() {
        ...
        if ($isPost) {
            ...
            $reviewModel = $objectManager->get ( 'Apptha\Marketplace\Model\Review' );
    ...
    public function sendReviewNotification($reviewDetails, $templateIdValue) {
        ...
        if ($notification == 1) {
             ...
             */
            $StoreData = $objectManager->create ( 'Apptha\Marketplace\Model\Seller' );
            ...
            foreach ( $senderIds as $senderId ) {
                $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
                $customerSession = $objectManager->create ( 'Magento\Customer\Model\Customer' );
