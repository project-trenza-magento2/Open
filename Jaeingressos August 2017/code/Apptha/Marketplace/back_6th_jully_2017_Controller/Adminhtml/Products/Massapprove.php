...
class Massapprove extends \Magento\Backend\App\Action {
    ...
    public function execute() {
        ...
        foreach ( $result as $approvalProductId ) {
            try {
                $customerObject = $this->_objectManager->create ( '\Magento\Catalog\Model\Product' );
                ...
                $sellerDetails = $objectManager->create ( 'Magento\Customer\Model\Customer' );
                ...
                $adminInfo = $objectManager->get ( 'Apptha\Marketplace\Helper\Data' );
