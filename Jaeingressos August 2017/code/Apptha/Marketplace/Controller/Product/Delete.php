...
class Delete extends \Magento\Framework\App\Action\Action {
     ...
     */
    public function __construct(\Magento\Framework\App\Action\Context $context, \Apptha\Marketplace\Helper\Data $dataHelper, \Magento\Framework\Message\ManagerInterface $messageManager) {
    ...
    public function sellerProductDelete($productId) {
         ...
         * Get product object
         */
        $productObject = $objectManager->get ( 'Magento\Catalog\Model\Product' )->load ( $productId );
