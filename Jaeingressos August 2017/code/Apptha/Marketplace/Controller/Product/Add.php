...
class Add extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        $seller = $objectManager->get ( 'Apptha\Marketplace\Model\Seller' );
        ...
        if (empty ( $storeName )) {
            $this->messageManager->addNotice (iconv('ISO-8859-1', 'UTF-8', __( 'Adicione as informações restantes para poder vender com a gente ;)' ))  );
        ...
        if ($customerObj->isLoggedIn () && $status == 1) {
            ...
            if ($isSellerSubscriptionEnabled && $productId == '') {
                ...
                if (count ( $subscriptionProfiles )) {
                     ...
                     */
                    $product = $objectManager->get ( 'Magento\Catalog\Model\Product' )->getCollection ()->addFieldToFilter ( 'seller_id', $customerId );
