        ...
        if (isset ( $_FILES ['product_images'] ) && isset ( $_FILES ['product_images'] ['name'] )) {
            ...
            for($inc = 0; $inc < $imageCount; $inc ++) {
                ...
                <div class="image_holder image-placeholder">
                    <input name="product_images[0]" id="upload_product_images" multiple="" type="file">
                    <p class="image-placeholder-text">Clique aqui para adicionar imagens</p>
                </div>
                <span><span class="image_close">x</span>
                <span class="base_image_container">
                <input class="base_image" type="radio" name="base_image" value="' . $fileName . '" checked style="opacity:0"> 
                
                </span> 
                <img src="' . $absPath . '" alt="' . $absPath . '" height="200" width="200">
                <input class="hidden_uploaded_image_path" type="hidden" name="images_path[0]" value="' . $fileName . '" /></span>';
            }
        }
        /**
