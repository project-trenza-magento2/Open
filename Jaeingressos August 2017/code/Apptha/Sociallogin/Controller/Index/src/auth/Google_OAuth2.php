...
class Google_OAuth2 extends Google_Auth {
     ...
     *
     * @param Google_AssertionCredentials $assertionCredentials
     *            optional.
     * @return void
     */
    ...
    private function getFederatedSignOnCerts() {
        ...
        $request = Google_Client::$io->makeRequest ( new Google_HttpRequest ( self::OAUTH2_FEDERATED_SIGNON_CERTS_URL ) );
        if ($request->getResponseHttpCode () == 200) {
